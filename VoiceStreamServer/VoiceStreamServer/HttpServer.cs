...
{
    // SEE: https://16bpp.net/tutorials/csharp-networking/02/
    //
    class HttpServer
    {
        public static HttpListener listener;
        public static string url = "http://127.0.0.1:1234/";
        ...
        public static async Task HandleIncomingConnections()
        {
            ...
            while (runServer)
            {
                ...
                else
                {
                    ...
                    string st = "";
                    foreach (byte X in nComp) { st = st + String.Format("0x{0:X2}", X) + ", "; }
